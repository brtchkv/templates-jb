# UI для управления списками автоматической рассылки писем
    ...
    Diclaimer: тестовые данные статистики за 19-20ые года, поэтому для отображения графиков надо отмотать на соответствующий период
...
#### Тех-Стек: 
* **Frontend**: 
    1. *Yarn* для упраления зависимостями
...
* **Backend**: 
    1. Аудентификация и авторизация пользователя 
